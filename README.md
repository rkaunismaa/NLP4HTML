...
So it would appear the code in, say, ../models/book.js will be where we implement out MySQL access code ... OK ... the mongoose tutorial initiates the connection to the db in app.js, so of course, this will be where we open our connection to mysql ... 